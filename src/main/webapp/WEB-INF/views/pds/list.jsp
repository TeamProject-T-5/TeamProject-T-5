  ...
  <div id="main">
     ...
     <table id="PdsList">
       ...
       <tr>
         ...
         <a href="/Pds/WriteForm?menu_id=${ menu_id }&nowpage=${ map.nowpage }&bnum=0&lvl=0&step=0&nref=0">[새 글 쓰기]</a>
         </td>
       </tr>
       <tr>
         <td>번호</td>
         ...
         <td>        
           ...
           <c:choose> 
            <c:when test="${ pds.lvl eq 0 }">
              <a href="/Pds/View?menu_id=${ pds.menu_id }&nowpage=${ map.nowpage }&idx=${pds.idx}">
              ${ pds.title }
              </a>
            </c:when>            
            <c:otherwise>
