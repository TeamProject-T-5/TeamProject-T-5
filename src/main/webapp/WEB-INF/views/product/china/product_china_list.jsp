...
<meta charset="UTF-8">
<title>중식</title>
<link rel="stylesheet" href="/css/product/china/china_list.css">
...
<%@include file="/WEB-INF/views/include/nav.jsp" %>
	<c:forEach var="chinaList"  items="${ chinaList }">
        <tr>	
		 <a href="/product/china/detail/china_detail?product_number=${chinaList.product_number}">${chinaList.product_name}</a>
		 <td>${chinaList.product_name}</td>
		 
		 <td>${chinaList.product_price}</td>
