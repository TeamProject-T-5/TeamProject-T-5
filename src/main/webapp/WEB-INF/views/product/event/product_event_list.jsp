...
<meta charset="UTF-8">
<title>이벤트</title>
<link rel="stylesheet" href="/css/product/event/evnet_list.css">
...
<body>
  ...
  <c:forEach var="eventList"  items="${ eventList }">
        <tr>	
		 <a href="/product/event/detail/event_detail?product_number=${eventList.product_number}">${eventList.product_name}</a>
		 <td>${eventList.product_name}</td>
		 
		 <td>${eventList.product_price}</td>
